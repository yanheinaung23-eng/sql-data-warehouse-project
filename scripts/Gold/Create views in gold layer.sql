...
Usage : These views can be directly queried in -> Datawarehouse > Views
-------------------------------------------------------------------
Author: Yan
*/
...
-- Create the dim_customers view in the gold schema
...
---------------------------------------------------------------------------------
-- Create the dim_products view in the gold schema
